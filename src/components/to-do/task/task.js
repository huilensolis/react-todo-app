...
function TodoTask({ title, completed, completeTaskFunction, deleteTaskFunction }) {
  ...
  return (
    <li className={isHovering === title ? "maybe-delete-background-red" : ""}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512" className="delete-task-icon icon" onClick={deleteTask} onMouseEnter={() => handleMouseEnter(title)} onMouseLeave={handleMouseLeave} >
